...
@Controller
@RequestMapping("/akunting/transaksi/validasi-jurnal-pendapatan")
public class ValidasiJurnalPendapatanController {
    ...
    public ModelAndView showPage() {
        ...
        modelAndView.setViewName("/transaksi/validasiJurnalPendapatan");
        return modelAndView;
    }
