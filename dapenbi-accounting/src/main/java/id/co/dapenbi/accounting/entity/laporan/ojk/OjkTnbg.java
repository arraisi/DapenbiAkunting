...
public class OjkTnbg {
    ...
    @Column(name = "NAMA_TANAH")
    private String namaTanah;

    @Column(name = "NO_SERTIFIKAT")
    private String noSertifikat;

    @Column(name = "ALAMAT_LOKASI")
    ...
    @Column(name = "NILAI_PEROLEHAN_LAP")
    private BigDecimal nilaiPerolehanLap;

    @Transient
    @JsonProperty("nilaiPerolehanLapFormatted")
    public String getNilaiPerolehanLapFormatted() {
        return nilaiPerolehanLap.toString();
    }
