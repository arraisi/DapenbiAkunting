...
public class OjkUmpj {
    ...
    @Transient
    @JsonProperty("jumlah1Formatted")
    public String getJumlah1Formatted() {
        return jumlah1.toString();
    }
    ...
    @Transient
    @JsonProperty("jumlah2Formatted")
    public String getJumlah2Formatted() {
        return jumlah2.toString();
    }
