...
public class OjkLan {
    ...
    @Id
    @SequenceGenerator(sequenceName = "OJK_LAN_SEQ", allocationSize = 1, name = "ojkLanGenerator")
    @GeneratedValue(generator = "ojkLanGenerator")
    ...
    @Column(name = "PRESENTASE_INVESTASI")
    private BigDecimal persentaseInvestasi;
