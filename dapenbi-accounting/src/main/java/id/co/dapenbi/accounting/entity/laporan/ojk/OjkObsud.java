...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "OJK_OBSUD")
public class OjkObsud {

    @Id
    @SequenceGenerator(sequenceName = "OJK_OBSUD_SEQ", allocationSize = 1, name = "ojkObsudGenerator")
    @GeneratedValue(generator = "ojkObsudGenerator")
