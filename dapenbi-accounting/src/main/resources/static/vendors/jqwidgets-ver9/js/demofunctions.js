...
$(document).ready(function () {
	...
	//		var items = $(".title_nav").find('li');
		...
		//	window.open('http://www.jqwidgets.com/jquery-widgets-demo/mobiledemos/', '_self');
	//	}
    }
    else {
        initDemo(true);
...
function initDemo(ismobile, isIndex) {
    ...
    if (ismobile) {
        ...
        if (!isIndex) {
            ...
            var initialurl = "https://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/styles/jqx.";
